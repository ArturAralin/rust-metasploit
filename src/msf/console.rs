...
pub async fn create(client: Client) -> Result<res::console::create, MsfError> {
  ...
  let byte = req::console::create(
    "console.create".to_string(),
...
pub async fn destroy(client: Client, consoleID: &str) -> Result<bool, MsfError> {
  ...
  let mut buf = vec![];
  let mut serializer = Serializer::new(&mut body);
  let byte = req::console::destroy(
    "console.destroy".to_string(),
    client.token.unwrap(),
    consoleid,
  );
  byte.serialize(&mut serializer).unwrap();
...
pub async fn detach_session(client: Client, consoleID: &str) -> Result<bool, MsfError> {
  ...
  let mut buf = vec![];
  let mut serializer = Serializer::new(&mut body);
  let byte = req::console::session_detach(
    "console.session_detach".to_string(),
    client.token.unwrap(),
    consoleid,
  );
  byte.serialize(&mut serializer).unwrap();
...
pub async fn kill_session(client: Client, consoleID: &str) -> Result<bool, MsfError> {
  ...
  let mut buf = vec![];
  let mut serializer = Serializer::new(&mut body);
  let byte = req::console::session_kill(
    "console.session_kill".to_string(),
    client.token.unwrap(),
    consoleid,
  );
  byte.serialize(&mut serializer).unwrap();
...
pub async fn tabs(
  ...
  let mut buf = vec![];
  let mut serializer = Serializer::new(&mut body);
  let byte = req::console::tabs(
    "console.tabs".to_string(),
    client.token.unwrap(),
    consoleid,
    inputline,
  );
